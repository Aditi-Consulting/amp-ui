  ...
  >
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <!-- Modal Body - Always show alert details -->
        <div class="modal-body">
          ...
          <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body">
              <!-- Loading State -->
              <div v-if="taskAgentLoading && !taskAgentData" class="text-center py-4">
              ...
              <!-- Error State -->
              <div v-else-if="taskAgentError && !taskAgentData" class="alert alert-warning m-0">
                <h6 class="alert-heading">
                  <i class="bi bi-exclamation-triangle me-2"></i>
                  Unable to Load Task Agent Data
                </h6>
              ...
              <div v-else class="text-center py-4 text-muted">
                <div class="d-flex align-items-center justify-content-center">
                  ...
                  <span>Waiting for task agent data...</span>
                </div>
                <p class="mt-2 small">No task agent data available yet. Auto-refreshing every 5 seconds.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          <!-- Super Agent and Task Agent buttons hidden - triggers are now handled by backend automatically -->
          <!-- <div>
            <button
...
// Computed property to check if resolution steps should be read-only (Splunk/ServiceNow source alerts)
const isReadOnlyResolution = computed(() => {
  const source = (props.alert?.source || "").toLowerCase();
